...
ActiveRecord::Schema.define(version: 2020_01_19_172124) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["recipe_id", "user_id"], name: "index_comments_on_recipe_id_and_user_id", unique: true
  ...
  create_table "recipes", force: :cascade do |t|
    ...
    t.index ["accepted"], name: "index_recipes_on_accepted"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["forgot_password_token"], name: "index_users_on_forgot_password_token"
    t.index ["mod"], name: "index_users_on_mod"
